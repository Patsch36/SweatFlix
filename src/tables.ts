...
export const initTables = async () => {
  ...
  VALUES 
    ...
    promise = await databaseStore.getDatabase()
      ...
      VALUES
        (1,  0, 0, '[11, 12]', 'Incline Bench Press', 'This exercise primarily targets the upper chest muscles. To perform this exercise, lie back on an incline bench. Hold a barbell or dumbbells above your chest with your arms fully extended. Lower the weights to your chest, then push them back up to the starting position. This movement should be done in a controlled manner, focusing on the contraction and stretch of your upper chest muscles.', ''),
        ...
        (1,  1, 0, '[]', 'Dumbbell Flyes', 'This exercise targets the upper chest muscles. Lie on an incline bench with a dumbbell in each hand. Extend your arms above you with a slight bend at the elbows. Lower your arms out to the sides in a wide arc until you feel a stretch in your chest. Return your arms back to the starting position.', ''),
