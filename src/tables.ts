...
export const initTables = async () => {
  ...
  VALUES 
    ...
    promise = await databaseStore.getDatabase()
      ...
      VALUES
        (1, 'Incline Bench Press', 'This exercise primarily targets the upper chest muscles. To perform this exercise, lie back on an incline bench. Hold a barbell or dumbbells above your chest with your arms fully extended. Lower the weights to your chest, then push them back up to the starting position. This movement should be done in a controlled manner, focusing on the contraction and stretch of your upper chest muscles.', ''),
        (2, 'Bench Press', 'This exercise targets the middle chest muscles. Lie flat on a bench with your feet firmly planted on the ground. Hold a barbell or dumbbells above your chest with arms fully extended. Lower the weights to your chest and then press them back up to the starting position, engaging your middle chest muscles throughout the movement.', ''),
        (3, 'Decline Bench Press', 'This exercise targets the lower chest muscles. Lie on a decline bench with your feet securely hooked under the leg brace. Lift a barbell or dumbbells from the rack and hold it straight over your chest with your arms fully extended. Lower the weights until they lightly touch your lower chest, then push them back up, focusing on using your lower chest muscles.', ''),
        (4, 'Pull-Up', 'This exercise targets the upper latissimus dorsi muscles (upper back). Hang from a pull-up bar with your hands slightly wider than shoulder-width apart and palms facing away from you. Pull yourself up until your chin is above the bar, squeezing your shoulder blades together at the top of the movement. Lower yourself back down in a controlled manner.', ''),
        (5, 'Seated Row', 'This exercise targets the lower latissimus dorsi muscles (lower back). Sit at a rowing machine with your feet on the footrests and knees slightly bent. Grab the handle and pull it towards your torso while keeping your back straight and shoulders down. Extend your arms to return to the starting position, engaging your lower lats throughout.', ''),
        (6, 'Shrug', 'This exercise targets the trapezius muscles (upper back and neck). Stand straight with a weight in each hand, arms fully extended, and palms facing your torso. Lift your shoulders up as high as possible while keeping your arms extended, then lower them back down after a short pause.', ''),
        (7, 'Neck Extension', 'This exercise targets the neck muscles. Sit or stand upright and tilt your head backward as far as comfortably possible, providing resistance with your hand or a resistance band for added intensity.', ''),
        (8, 'Incline Dumbbell Curl', 'This exercise targets the long head of the biceps brachii muscle (upper arm). Sit back on an incline bench with a dumbbell in each hand held at arm´s length, palms facing forward. Curl the weights while keeping your upper arms stationary, then lower them back down after a short pause.', ''),
        (9, 'Preacher Curl', 'This exercise targets the short head of the biceps brachii muscle (upper arm). Sit at a preacher bench and place your upper arms on the pad, holding a barbell or dumbbells with an underhand grip. Curl the weights up until your biceps are fully contracted, then lower them back down after a short pause.', ''),
        (10, 'Hammer Curl', 'This exercise targets the brachialis muscle (upper arm). Stand up straight with a dumbbell in each hand, arms fully extended, and palms facing your torso (neutral grip). Curl the weights while keeping your upper arms stationary, then lower them back down after a short pause.', ''),
        (11, 'Overhead Triceps Extension', 'This exercise targets the long head of the triceps brachii muscle (back of upper arm). Stand or sit with a dumbbell held by both hands overhead at arm´s length. Lower it behind your head by bending at the elbow, then extend your arm to return to starting position.', ''),
        (12, 'Triceps Pushdown', 'This exercise targets the medial head of the triceps brachii muscle (back of upper arm). Stand in front of a cable machine with a bar attachment set at upper chest level. Grab it with an overhand grip and push it down until your arms are fully extended, then return to starting position after a short pause.', ''),
        (13, 'Skull Crusher', 'This exercise targets lateral head of triceps brachii muscle (back of upper arm). Lie on a flat bench holding an EZ curl bar or dumbbells directly above you with arms fully extended. Bend at elbows to lower weights towards forehead (hence "skull crusher"), then extend arms to return to starting position.', ''),
        (14, 'Leg Extension', 'This exercise targets quadriceps muscles (front of thigh). Sit on a leg extension machine with feet under foot pad and hands holding side bars for support. Extend legs until they´re parallel to floor, then slowly return to starting position.', ''),
        (15, 'Leg Curl', 'This exercise targets hamstring muscles (back of thigh). Lie face down on leg curl machine with ankles hooked under foot pad and hands holding side bars for support. Curl legs towards buttocks as far as comfortably possible, then slowly return to starting position.', ''),
        (16, 'Hip Adduction', 'This exercise targets adductor muscles (inner thigh). Sit on a hip adduction machine with legs spread wide and feet on foot pads. Bring legs together against resistance, then slowly return to starting position.', ''),
        (17, 'Calf Raise', 'This exercise targets calf muscles. Stand upright holding weights with feet hip-width apart. Rise up onto toes, hold for a moment, then lower back down.', ''),
        (18, 'Front Raise', 'This exercise targets anterior deltoid muscle (front of shoulder). Stand with feet shoulder-width apart holding weights in front of thighs. Raise weights in front of you until arms are parallel to floor, then lower back down.', ''),
        (19, 'Reverse Fly', 'This exercise targets posterior deltoid muscle (back of shoulder). Stand or sit and lean forward with weights in hands and elbows slightly bent. Lift weights out to sides until arms are parallel to floor, then lower back down.', ''),
        (20, 'Lateral Raise', 'This exercise targets lateral deltoid muscle (middle of shoulder). Stand with feet shoulder-width apart holding weights at sides. Lift weights out to sides until arms are parallel to floor, then lower back down.', ''),
        (21, 'Crunch', 'This exercise targets upper rectus abdominis muscle (upper abs). Lie on back with knees bent and hands behind head. Lift upper body towards knees using abdominal muscles, then lower back down.', ''),
        (22, 'Reverse Crunch', 'This exercise targets lower rectus abdominis muscle (lower abs). Lie on back with knees bent and hands at sides or under hips for support. Lift legs towards chest using abdominal muscles, then lower back down.', ''),
        (23, 'Russian Twist', 'This exercise targets the internal and external oblique muscles (sides of the abdomen). Sit on the floor with your knees bent, pull your abs to your spine, and lean back a few inches while keeping your back straight. Hold your hands in front of you and twist your torso to the right, then to the left to complete one rep, maintaining a strong core throughout. You can also hold a weight or a medicine ball in your hands for added resistance. This movement engages your obliques and helps improve core strength and stability.', '');
        `);
    ...
    promise = await databaseStore.getDatabase()
      ?.run(`INSERT INTO WorkoutList (id, workoutPlan, exerciseName, sets, reps)
      VALUES 
          (1, 'Chest-Code Workout', 'Incline Bench Press', 2, '8-12'),
          (2, 'Back-End Workout', 'Pull-Up', 3, '8-12'),
          (3, 'Back-End Workout', 'Seated Row', 3, '8-12'),
          (4, 'Back-End Workout', 'Shrug', 3, '8-12'),
          (5, 'Arm-Assembly Workout', 'Incline Dumbbell Curl', 3, '8-12'),
          (6, 'Arm-Assembly Workout', 'Preacher Curl', 3, '8-12'),
          (7, 'Arm-Assembly Workout', 'Hammer Curl', 3, '8-12'),
          (8, 'Leg-acy Code Workout', 'Leg Extension', 3, '8-12'),
          (9, 'Leg-acy Code Workout', 'Leg Curl', 3, '8-12'),
          (10, 'Leg-acy Code Workout', 'Hip Adduction', 3, '8-12'),
          (11, 'Push-Request Workout', 'Incline Bench Press', 3, '8-12'),
          (12, 'Push-Request Workout', 'Overhead Triceps Extension', 3, '8-12'),
          (13, 'Push-Request Workout', 'Front Raise', 3, '8-12'),
          (14, 'Pull-Request Workout', 'Pull-Up', 3, '8-12'),
          (15, 'Pull-Request Workout', 'Seated Row', 3, '8-12'),
          (16, 'Pull-Request Workout', 'Incline Dumbbell Curl', 3, '8-12'),
          (17, 'Pull-Request Workout', 'Hammer Curl', 3, '8-12'),
          (18, 'Leg-Endary Code Workout', 'Leg Extension', 3, '8-12'),
          (19, 'Leg-Endary Code Workout', 'Leg Curl', 3, '8-12'),
          (20, 'Leg-Endary Code Workout', 'Calf Raise', 3, '8-12'),
          (21, 'Full-Body Debugging Workout', 'Incline Bench Press', 3, '8-12'),
          (22, 'Full-Body Debugging Workout', 'Pull-Up', 3, '8-12'),
          (23, 'Full-Body Debugging Workout', 'Incline Dumbbell Curl', 3, '8-12'),
          (24, 'Full-Body Debugging Workout', 'Overhead Triceps Extension', 3, '8-12'),
          (25, 'Full-Body Debugging Workout', 'Leg Extension', 3, '8-12'),
          (26, 'Upper-Body Programming Workout', 'Incline Bench Press', 3, '8-12'),
          (27, 'Upper-Body Programming Workout', 'Pull-Up', 3, '8-12'),
          (28, 'Upper-Body Programming Workout', 'Incline Dumbbell Curl', 3, '8-12'),
          (29, 'Upper-Body Programming Workout', 'Overhead Triceps Extension', 3, '8-12'),
          (30, 'Lower-Body Programming Workout', 'Leg Extension', 3, '8-12'),
          (31, 'Lower-Body Programming Workout', 'Leg Curl', 3, '8-12'),
          (32, 'Lower-Body Programming Workout', 'Calf Raise', 3, '8-12'),
          (33, 'Full-Body Push Workout', 'Incline Bench Press', 3, '8-12'),
          (34, 'Full-Body Push Workout', 'Overhead Triceps Extension', 3, '8-12'),
          (35, 'Full-Body Push Workout', 'Front Raise', 3, '8-12'),
          (36, 'Full-Body Pull Workout', 'Pull-Up', 3, '8-12'),
          (37, 'Full-Body Pull Workout', 'Seated Row', 3, '8-12'),
          (38, 'Full-Body Pull Workout', 'Incline Dumbbell Curl', 3, '8-12'),
          (39, 'Full-Body Pull Workout', 'Hammer Curl', 3, '8-12');`);
